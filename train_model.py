...
Original file is located at
    https://colab.research.google.com/drive/1RS3tSGQJIOG7pz4_KjedcCf-Jm9iqisq
"""
...
def prep_df(path: str) -> pd.DataFrame:
    ...
    imgs = pd.DataFrame(imgs[:,-2], imgs[:,-1], columns=['label'])
...
train_imgs = prep_df('./dataset/images/train_set')
#test_imgs = prep_df('./food-101/meta/test.txt')
test_imgs = prep_df('./dataset/images/test_set')
...
model.to(device)
torch.save(model, "./model/food_classification.pt")
model.eval()
...
# Classify an image
image_path = "dataset/images/test_set/bibimbap/26376.jpg"
