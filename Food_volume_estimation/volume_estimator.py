...
class VolumeEstimator():
    ...
    def __init__(self, arg_init=True):
        ...
        if not arg_init:
            ...
            print(type(self.args.depth_model_weights))
    ...
    def classification_food(self, input_image):
        cnn_model = keras.models.load_model("..\\Food_Detection\\food_conv3_tf1.h5")
...
if __name__ == '__main__':
    ...
    for input_image in estimator.args.input_images:
        ...
        # dict = {'food' : [g, Kcal, carbohydrate, protein, fat, saccharide]}
        food_dic = {'apple': [100, 57, 14.36, 0.2, 0.03, 11.14], 'bibimbab': [537, 450, 84.76, 30.89, 19.44, 0.22],
                    'bulgogi': [486, 300, 14.77, 48, 38, 23.86, 0], 'chocolate_cake': [420,100,  43.6, 5.3, 25, 23],
                    'fried_egg': [89, 46, 0.43, 6.24, 6, 76, 0.38], 'hamburger': [270, 93, 26.8, 14.6, 11, 0],
                    'jajangmyeon': [785, 450, 129.41, 26.81, 19.98, 6.56], 'kimbap': [318, 200, 57.6, 7.3, 6.5, 0.5],
                    'kimchi_stew': [121, 200, 6.47, 7.51, 7.57, 1.77], 'pizza': [404, 150, 43.7, 15.6, 18.5, 5.4],
                    'ramen': [515, 369, 87.8, 11, 15.8, 0], 'sandwich': [352, 146, 33.35, 20.69, 15.48, 0],
                    'steak': [686, 200, 33.79, 29.3, 46.22, 0], 'sushi': [179, 125, 37.38, 5.37, 0.52, 0]}
        ...
        print("carbohydrate: ", food_dic[food][2], "% ", "protein: ", food_dic[food][3]*volume*0.01, "g, ", food_dic[food][3], "% ", "fat: ", food_dic[food][4]*volume*0.01, "g, ", food_dic[food][4], "% ",
              "saccharides: ", food_dic[food][5], "% ")
        ...
        pie = plt.pie(nutrients,
                      startangle=90,
                      counterclock=False,
                      autopct=lambda p: '{:.2f}g'.format(p * sum(nutrients) / 100),
